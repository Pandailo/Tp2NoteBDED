...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <logic:notEqual name="listWarsSize" value="0">
    <sj:tab forward="Ear Wars" selected="true"><bean:message key="tab.ear.wars"/></sj:tab>
  </logic:notEqual>
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.ear.wars.name"/></sj:jgColTitle>
        <sj:jgColTitle><bean:message key="title.ear.wars.path"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="earForm" property="wars">
