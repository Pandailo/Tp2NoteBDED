...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionPresentTopic">
    <bean:write name="topicForm" property="name"/>
  </sj:tab>
  <sj:tab forward="Topic Used By" selected="true"><bean:message key="tab.jms.topic.usedby"/></sj:tab>
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.jms.topic.usedby.ejb"/></sj:jgColTitle>
        <sj:jgColTitle><bean:message key="title.jms.topic.usedby.type"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="topicForm" property="listUsedByEjb">
        <sj:gridrow>
          <sj:gridcol>
