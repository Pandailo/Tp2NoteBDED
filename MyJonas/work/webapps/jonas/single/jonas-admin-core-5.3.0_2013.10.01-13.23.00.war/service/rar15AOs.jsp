...
<sj:tabs usingWhere="true" heightTab="20">
 ...
 <bean:size id="listCFSize" name="resourceAdapterForm" property="CF"/>
  ...
  <logic:notEqual name="listAOSize" value="0">
    <sj:tab forward="Rar AdminObjects" selected="true"><bean:message key="tab.rar.ao"/></sj:tab>
  </logic:notEqual>

  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.rar.ao"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="resourceAdapterForm" property="AO">
        <sj:gridrow valign="top">
          <sj:gridcol>            
            <html:link forward="ActionEditResourceAdapterAO" styleClass="panel"
