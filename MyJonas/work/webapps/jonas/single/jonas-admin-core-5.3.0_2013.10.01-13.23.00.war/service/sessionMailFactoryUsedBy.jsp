...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionEditSessionMailFactory"><bean:write name="mailFactoryForm" property="mailFactoryName"/></sj:tab>
  <sj:tab forward="Session Mail Factory Used By" selected="true"><bean:message key="tab.mailservice.mailfactory.usedby"/></sj:tab>
