...
<sj:tabs usingWhere="true" heightTab="20">
 ...
 <bean:size id="listCFSize" name="resourceAdapterForm" property="CF"/>
  <logic:notEqual name="listCFSize" value="0">
    <sj:tab forward="Rar ConnectionFactories" selected="true"><bean:message key="tab.rar.cf"/></sj:tab>
  </logic:notEqual>
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.rar.cf.name"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="resourceAdapterForm" property="CF">
        <sj:gridrow valign="top">
          <sj:gridcol>            
            <html:link forward="ActionEditResourceAdapterCF" styleClass="panel"
