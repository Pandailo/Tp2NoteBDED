...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionEditEar" selected="true">
  ...
  <logic:present name="earForm" property="xmlDeploymentDescriptor">
    <logic:notEqual name="earForm" property="xmlDeploymentDescriptor" value="null">
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:gridrow>
        <sj:jgName><bean:message key="label.ear.file"/></sj:jgName>
        <sj:jgValue><bean:write name="earForm" property="filename"/></sj:jgValue>
      </sj:gridrow>
      <sj:gridrow>
        <sj:jgName><bean:message key="label.ear.path"/></sj:jgName>
        <sj:jgValue><bean:write name="earForm" property="earPath"/></sj:jgValue>
      </sj:gridrow>
    </sj:jonasgrid>
  </sj:panel>
</sj:tabs>
