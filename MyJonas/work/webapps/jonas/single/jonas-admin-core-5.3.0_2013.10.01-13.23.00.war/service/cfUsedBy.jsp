...
<sj:tabs usingWhere="true" heightTab="20">
  <sj:tab forward="Jms Service"><bean:message key="tab.jmsservice"/></sj:tab>
  <sj:tab forward="ActionListConnectionFactories"><bean:message key="tab.jms.connfacts"/></sj:tab>
  <sj:tab forward="ActionPresentConnectionFactory">
    <bean:write name="cfForm" property="name"/>
  </sj:tab>
  <sj:tab forward="ConnectionFactory Used By" selected="true"><bean:message key="tab.jms.cf.usedby"/></sj:tab>
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.jms.cf.usedby.ejb"/></sj:jgColTitle>
        <sj:jgColTitle><bean:message key="title.jms.cf.usedby.type"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="cfForm" property="listUsedByEjb">
        <sj:gridrow>
          <sj:gridcol>
