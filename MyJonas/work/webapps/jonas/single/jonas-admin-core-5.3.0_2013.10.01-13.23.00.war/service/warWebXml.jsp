...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <logic:notEqual name="warForm" property="xmlContent" value="">
    <sj:tab forward="War Web Xml" selected="true"><bean:message key="tab.war.xmlContent"/></sj:tab>
  </logic:notEqual>
  ...
  <sj:panel>
    <sj:jonasgrid globalRowStyleClass="panel">
      <sj:gridrow>
        <sj:gridcol><sj:xmlFile><bean:write name="warForm" property="xmlContent"/></sj:xmlFile></sj:gridcol>
      </sj:gridrow>
    </sj:jonasgrid>
  </sj:panel>
</sj:tabs>
