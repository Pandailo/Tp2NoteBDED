...
<sj:tabs usingWhere="true" heightTab="20">
 ...
 <bean:size id="listCFSize" name="resourceAdapterForm" property="CF"/>
  ...
  <sj:tab forward="ActionEditResourceAdapterAO" selected="true">
    <bean:write name="resourceAdapterAOForm" property="name"/>
  </sj:tab>
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.resourceadapter.ao"/></sj:jgColTitle>
      </sj:jgRowTitle>
    </sj:jonasgrid>
    <sj:jonasgrid>
      <sj:gridrow>
        <sj:jgName><bean:message key="label.resourceadapter.name"/></sj:jgName>
        <sj:jgValue><bean:write name="resourceAdapterAOForm" property="name"/></sj:jgValue>
      </sj:gridrow>
      <sj:gridrow>
        <sj:jgName><bean:message key="label.resourceadapter.description"/></sj:jgName>
        <sj:jgValue><bean:write name="resourceAdapterAOForm" property="description"/></sj:jgValue>
      </sj:gridrow>
    </sj:jonasgrid>

    <bean:size id="listSize" name="resourceAdapterAOForm" property="listProperties"/>
    <logic:notEqual name="listSize" value="0">
      <sj:panelSeparator/>
      <sj:jonasgrid>
        <sj:jgRowTitle>
      ...
      <sj:jonasgrid>
        <logic:iterate id="item" name="resourceAdapterAOForm" property="listProperties">
          <sj:gridrow>
