...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <logic:notEqual name="listRarsSize" value="0">
    <sj:tab forward="Ear Rars" selected="true"><bean:message key="tab.ear.rars"/></sj:tab>
  </logic:notEqual>
  ...
  <sj:panel>
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.ear.rars.name"/></sj:jgColTitle>
        <sj:jgColTitle><bean:message key="title.ear.rars.path"/></sj:jgColTitle>
      </sj:jgRowTitle>
      <logic:iterate id="item" name="earForm" property="rars">
        <sj:gridrow valign="top">
          ...
          <sj:gridcol><bean:write name="item" property="filePath"/></sj:gridcol>
        </sj:gridrow>
      </logic:iterate>
    </sj:jonasgrid>
  </sj:panel>
