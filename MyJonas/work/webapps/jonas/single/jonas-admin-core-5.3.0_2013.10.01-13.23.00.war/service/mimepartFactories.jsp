...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionListMimePartMailFactories" selected="true"><bean:message key="tab.mailservice.mimeparts"/></sj:tab>
  <sj:panel>
    <sj:jonasgrid>
      <bean:size id="listSize" name="listMailFactories"/>
      <logic:equal name="listSize" value="0">
        <sj:gridrow>
          <sj:gridcol><bean:message key="message.mailservice.mimepart.none"/></sj:gridcol>
        </sj:gridrow>
      </logic:equal>
