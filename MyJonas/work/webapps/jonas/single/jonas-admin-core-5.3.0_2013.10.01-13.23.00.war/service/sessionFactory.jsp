...
<body class="content">
<html:form action="/ApplySessionMailFactory">
...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionEditSessionMailFactory" selected="true"><bean:write name="mailFactoryForm" property="mailFactoryName"/></sj:tab>
  <bean:size id="listSize" name="mailFactoryForm" property="listUsedByEjb"/>
  <logic:notEqual name="listSize" value="0">
    <sj:tab forward="Session Mail Factory Used By"><bean:message key="tab.mailservice.mailfactory.usedby"/></sj:tab>
  </logic:notEqual>
  ...
  <sj:panel>
    ...
    <sj:jonasgrid>
      <sj:gridrow>
        ...
        <sj:gridcol><bean:message key="message.mailservice.mailfactory.session"/></sj:gridcol>
      </sj:gridrow>
      <sj:gridrow>
