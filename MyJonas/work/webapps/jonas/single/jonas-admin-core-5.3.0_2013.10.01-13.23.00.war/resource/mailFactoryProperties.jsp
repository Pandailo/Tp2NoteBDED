...
<body class="content">
<html:form action="/ApplyMailFactoryProperties">
...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionEditMailFactoryProperties" selected="true"><bean:message key="tab.resource.mailfactory.properties"/></sj:tab>
  ...
  <sj:panel>
    ...
    <sj:jonasgrid>
      <sj:gridrow>
        ...
        <sj:gridcol valign="top"><html:text property="mailFactoryName" size="40"/></sj:gridcol>
        <sj:gridcol width="60%"><bean:message key="comment.resource.mailfactory.properties.name"/></sj:gridcol>
      </sj:gridrow>
    </sj:jonasgrid>
    ...
    <sj:jonasgrid>
      <sj:gridrow>
        ...
        <sj:gridcol>
          <html:radio property="type" value="javax.mail.Session"/><bean:message key="label.resource.mailfactory.type.session"/>
          <html:radio property="type" value="javax.mail.internet.MimePartDataSource"/><bean:message key="label.resource.mailfactory.type.mimepart"/>
        </sj:gridcol>
        <sj:gridcol width="60%">
        </sj:gridcol>
      </sj:gridrow>
