...
<body class="content">
<html:form action="/ApplyJoramWriter">
...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionAddJoramWriter" selected="true"><bean:message key="tab.joramplatform.joramwriter.add"/>
  </sj:tab>
  ...
  <sj:panel>
    ...
    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.joramplatform.writer"/></sj:jgColTitle>
      </sj:jgRowTitle>
    </sj:jonasgrid>
