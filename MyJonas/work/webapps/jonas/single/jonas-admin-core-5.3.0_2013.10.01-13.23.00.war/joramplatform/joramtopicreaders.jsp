...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="JoramTopicReaders" selected="true">
  ...
  <sj:panel>
    <bean:size id="listSize" name="joramTopicForm" property="readerList"/>
    <sj:jonasgrid>
      <sj:jgRowTitle level="2">
        <sj:jgColTitle><bean:message key="title.joramreaders.action"/></sj:jgColTitle>
      </sj:jgRowTitle>
    </sj:jonasgrid>
    <sj:jonasgrid>
      <sj:gridrow changeStyle="true">
        <sj:gridcol>
          <sj:grid cellPadding="10">
            <sj:gridrow>
              <sj:gridcol>
                <sj:jonasbutton forward="ActionAddJoramReader">
                  <bean:message key="button.joramreaders.action.add"/>
                </sj:jonasbutton>
              </sj:gridcol>
            </sj:gridrow>
          </sj:grid>
    ...
    <sj:jonasgrid>
      <logic:equal name="listSize" value="0">
        <sj:gridrow>
          <sj:gridcol>
            <bean:message key="message.joramreaders"/>
          </sj:gridcol>
        </sj:gridrow>
      </logic:equal>
      ...
      <logic:notEqual name="listSize" value="0">
        ...
        <logic:iterate id="item" name="joramTopicForm" property="readerList">
          <sj:gridrow>
