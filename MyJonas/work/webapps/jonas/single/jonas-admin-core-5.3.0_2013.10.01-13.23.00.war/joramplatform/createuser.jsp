...
<body class="content">
<html:form action="/ApplyJoramUser">
...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <logic:equal name="isLocalServer" value="true">
    <logic:equal name="collocatedServer" value="true">
      <sj:tab forward="JoramUsersAfterCreate"><bean:message key="tab.joramplatform.joramlocalaftercreate"/></sj:tab>
    </logic:equal>
    <logic:notEqual name="collocatedServer" value="true">
      <sj:tab forward="JoramUsersAfterCreate"><bean:message key="tab.joramplatform.joramaftercreate"/></sj:tab>
    </logic:notEqual>
  </logic:equal>
  <logic:notEqual name="isLocalServer" value="true">
    <sj:tab forward="JoramUsersAfterCreate"><bean:message key="tab.joramplatform.joramaftercreate"/></sj:tab>
  </logic:notEqual>
  <sj:tab forward="ActionCreateJoramUser" selected="true"><bean:message key="tab.joramplatform.joramuser.create"/></sj:tab>
  <sj:panel>

    <sj:jonasgrid>
      <sj:jgRowTitle>
        <sj:jgColTitle><bean:message key="title.joramplatform.user"/></sj:jgColTitle>
      </sj:jgRowTitle>
    </sj:jonasgrid>
    ...
    <sj:jonasgrid>
      ...
      <sj:gridrow>
        <sj:jgName><bean:message key="label.joramplatform.user.password"/></sj:jgName>
        <sj:gridcol valign="top"><html:password property="password"/></sj:gridcol>
      </sj:gridrow>
    </sj:jonasgrid>
