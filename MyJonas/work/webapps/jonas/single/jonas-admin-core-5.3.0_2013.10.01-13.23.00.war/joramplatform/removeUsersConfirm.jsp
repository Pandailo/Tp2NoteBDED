...
<sj:tabs usingWhere="true" heightTab="20">
  ...
  <sj:tab forward="ActionRemoveJoramUsers" selected="true"><bean:message key="tab.joramplatform.removeusers.confirm"/></sj:tab>
  <sj:panel>
    <sj:jonasgrid>
      <bean:size id="listSize" name="removeUsersForm" property="selectedItems"/>
      <!-- Empty List -->
      <logic:equal name="listSize" value="0">
        <sj:gridrow styleClass="errors">
          <sj:gridcol><bean:message key="message.joramplatform.users.list.empty"/></sj:gridcol>
        </sj:gridrow>
      </logic:equal>
      <!-- Full List -->
      <logic:notEqual name="listSize" value="0">
        ...
        <logic:iterate id="item" name="removeUsersForm" property="selectedItems">
          <sj:gridrow>
    ...
    <logic:notEqual name="listSize" value="0">
      ...
      <sj:jonasgrid globalRowStyleClass="panel">
        <sj:gridrow>
          <sj:gridcol>
            <sj:jonasbutton forward="ActionRemoveConfirmUsers">
